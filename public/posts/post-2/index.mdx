...
<Image
  src='https://img.shields.io/badge/TypeScript-3178C6.svg?style=for-the-badge&logo=TypeScript&logoColor=black'
  alt='예시 이미지'
  width={100}
  height={100}
/>
...
**앞으로 이 블로그를 통해 '기록하는 습관'을 키워, 같은 문제를 반복해서 겪지 않도록 정리하면서 문제 해결 능력을 키워나갈 수 있었으면 좋겠다.**
